...
def get_pose_net(cfg, is_train, **kwargs):
    # model = AggPose(img_size_x=cfg.MODEL.IMAGE_SIZ[1], img_size_y=cfg.MODEL.IMAGE_SIZE[0], patch_size=4, num_classes=cfg.EMODEL.NUM_JOINTS, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],

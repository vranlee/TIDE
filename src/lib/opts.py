...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('task', default='cmot', help='mot, cmot')
        ...
        self.parser.add_argument('--pre_cm', action='store_true')
        self.parser.add_argument('--temp_loss', action='store_true')
        self.parser.add_argument('--hm_disturb', type=float, default=0.05)
        self.parser.add_argument('--lost_disturb', type=float, default=0.4)
        ...
        self.parser.add_argument('--cnt_weight', type=float, default=1000,
                                 help='loss weight for counting')
    ...
    def init(self, args=''):
        default_dataset_info = {
            ...
            'cmot': {'default_resolution': [608, 1088], 'num_classes': 1,
                     'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
                     'dataset': 'jde', 'nID': 14455},
        }
